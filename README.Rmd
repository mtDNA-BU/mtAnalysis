...
```{r chunk display histograms in pdf, echo=F, include=T, eval=T}
knitr::include_graphics('https://github.com/mtDNA-BU/ANNOmtDNA/tree/master/man/figures/mtHistograms.pdf')
```


```{r chunk convert pdf to png, echo=F, include=F, eval=F}
library(pdftools)
...
```{r chunk 13, echo=F, fig.align = 'center', out.height="60%", out.width="60%", eval=F}
library(EBImage)
