...
**Authors:** Xianbang Sun (maintainer, sxb3000@bu.edu), Katia Bulekova, Chunyu Liu, Jessica L. Fetterman<br>
...
```{r chunk 12, echo=F}
annotate_file <- read.csv(paste0(output_path, "/ARIC_annotation_variation.csv"))
annotate_file[annotate_file$mtID == 3308, ]
```
