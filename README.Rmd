...
```{r chunk convert pdf, echo=F, include=F}
library(pdftools)
pdf_pages <- pdf_info(paste0(output_path, "mtHistograms.pdf"))$pages
filenames<-paste0(output_path, "mtHistograms_", seq_len(pdf_pages), ".jpg")
pdf_convert(paste0(output_path, "mtHistograms.pdf"), format = "jpg", pages=seq_len(pdf_pages), filenames=filenames)
```

```{r chunk 13, echo=F, fig.align = 'center', out.height="50%", out.width="50%"}
