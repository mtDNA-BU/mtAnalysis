...
#'
#' Produce a scatter plot of Mean Coverage Across Subjects
#'
...
#'
plotSubjectMeanCoverage <- function(x, loci=c(1:16569),
                                 col = "blue", pch='.', cex=0.2, xlab="mtloci", ylab="",
                                 main = "Mean Coverage across Subjects",
                                 ...) {
  ...
  plot(x = seq(1 : (dim(x)[2]) ),
       y = colMeans(x[loci,], na.rm=T),
       col = col,
       pch = pch,
       cex = cex,
       xlab = xlab,
